...
coordSet["Principal Investigator"] = {
...
coordSet["Tissue Engineer"] = {
    "character": "Tissue Engineer",
    "imgid": "right",
    "top": "-260px",
    "left": "190px"
}

coordSet["Experimentalist"] = {
    "character": "Experimentalist",
    "imgid": "right",
    "top": "-230px",
    "left": "280px"
}

coordSet["Image Analyst"] = {
    "character": "Image Analyst",
    "imgid": "right",
    "top": "-210px",
    "left": "430px"
}

coordSet["Bioinformatician"] = {
    "character": "Bioinformatician",
    "imgid": "right",
    "top": "-225px",
    "left": "480px"
}
...
async function replayDialog(idx) {
    ...
    for (let i = idx; i < dialog.length; ++i) {
        ...
        console.log("Showing ->" + dialog[i].character  + "  " + dialog[i].command)
...
function watchfileInput(files) {
    if (files.length) {
        ...
        if (file) {
            ...
            var filelable = document.getElementById("successupload");
            filelable.style.display = "block";
            var info = "File uploaded (`" + file.name + "`). Please click **\"Replay\"** to show BioResearchDev's research and experimentation process";
            filename = file.name;
            filelable.innerHTML = md.render(info);
        }
    }
...
function extraction(contents) {
    ...
    const regex_start = /(Research Process Starts)([\D\s])*(\d*)/g;
...
function createPara(d, i) {
    ...
    singleDialog.style.width = "540px";
    ...
    if (d.type && d.character) {
        ...
        } else if (d.character == "Principal Investigator") {
            characterimg.src = "figures/pi.png";
        } else if (d.character == "Research Assistant") {
            characterimg.src = "figures/ra.png";
        } else if (d.character == "Tissue Engineer") {
            characterimg.src = "figures/te.png";
        } else if (d.character == "Experimentalist") {
            characterimg.src = "figures/exp.png";
        } else if (d.character == "Image Analyst") {
            characterimg.src = "figures/ia.png";
        } else if (d.character == "Bioinformatician") {
            characterimg.src = "figures/binf.png";
        } 
        ...
        var renderedHtml = md.render("Research Problem:    " + d.task);
